...
type Patient struct {
	...
	DeceasedBoolean      *bool                  `json:"deceasedBoolean,omitempty"`      // Indicates if/when the individual is deceased
	DeceasedDateTime     *string                `json:"deceasedDateTime,omitempty"`     // Indicates if/when the individual is deceased
	...
	MultipleBirthBoolean *bool                  `json:"multipleBirthBoolean,omitempty"` // Whether patient is part of a multiple birth
