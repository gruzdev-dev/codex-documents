...
type Observation struct {
	...
	Status                string                      `json:"status"`                          // registered | specimen-in-process | preliminary | final | amended | corrected | appended | cancelled | entered-in-error | unknown | cannot-be-obtained
	Category              []CodeableConcept           `json:"category,omitempty"`              // Classification of  type of observation
	Code                  *CodeableConcept            `json:"code"`                            // Type of observation (code / type)
...
type ObservationComponent struct {
	...
	Code                 *CodeableConcept            `json:"code"`                           // Type of component observation (code / type)
	...
	Interpretation       []CodeableConcept           `json:"interpretation,omitempty"`       // High, low, normal, etc
	ReferenceRange       []ObservationReferenceRange `json:"referenceRange,omitempty"`       // Provides guide for interpretation of component result value
}

type ObservationTriggeredBy struct {
	Id          *string    `json:"id,omitempty"`     // Unique id for inter-element referencing
	Observation *Reference `json:"observation"`      // Triggering observation
	Type        string     `json:"type"`             // reflex | repeat | re-run
